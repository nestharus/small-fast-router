...
public class HttpRouter2Test {
  ...
  class StaticRoutes {
    ...
    void staticTextWithSpecialCharacters() {
      ...
      assertEquals(List.of("file.txt"), router.getNodes().stream().map(Object::toString).toList());
    }
    ...
    void optionalStaticText() {
      ...
      assertEquals(List.of("optional?"), router.getNodes().stream().map(Object::toString).toList());
    }
  }
  ...
  class StarRoutes {
    ...
    void starWithPrefix() {
      ...
      assertEquals(List.of("files*"), router.getNodes().stream().map(Object::toString).toList());
    }
    ...
    void starWithSuffix() {
      HttpRouter2<HttpParameters> router = new HttpRouter2<>();
      router.add("/*.txt", null);
      assertEquals(List.of("*", ".txt"), router.getNodes().stream().map(Object::toString).toList());
    }
  ...
  class DoubleStarRoutes {
    ...
    void doubleStarWithPrefix() {
      ...
      assertEquals(
          List.of("files", "docs**[0]"), router.getNodes().stream().map(Object::toString).toList());
    }
